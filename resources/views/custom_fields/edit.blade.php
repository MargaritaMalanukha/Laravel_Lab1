...
@section('content')
    ...
    <section class="admin-panel-container">
        <div class="admin-panel-block" style="align-items: center">
            <form action="{{ route('custom_fields.update', $field->field) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row" style="margin-bottom: 50px; margin-top: 50px; display: flex; flex-direction: column; align-items: center">
                    <div class="admin-page-line">
                        <div class="form-group">
                            ...
                            <input type="text" name="field" class="form-control" value="{{ $field->field }}">
                        </div>
                    </div>
                    <div class="admin-page-line">
                        <div class="form-group">
                            <strong>Field caption:</strong>
                            <input type="text" name="caption" class="form-control" value="{{ $field->caption }}">
                        </div>
                    </div>
                    <div class="admin-page-line">
                        <div class="form-group">
                            <strong>Entity:</strong>
                            <input type="text" name="entity" class="form-control" value="{{ $field->entity }}">
                        </div>
                    </div>
